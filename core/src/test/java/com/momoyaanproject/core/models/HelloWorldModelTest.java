 ...
 */
package com.momoyaanproject.core.models;
...
import com.momoyaanproject.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "momoyaanproject/components/helloworld");
